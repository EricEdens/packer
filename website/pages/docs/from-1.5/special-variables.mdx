---
layout: docs
page_title: Special Variables - HCL Configuration Language
sidebar_title: Special Variables
description: |-
...
Build variables will allow you to access, from provisioners and post-processors, connection information and basic instance state information.
All special build variables are prefixed with `build`:
...
The valid build variables to request are:
